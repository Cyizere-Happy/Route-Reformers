...
export default function ReviewAndContact() {
  ...
  if (!search || !selection) return <View style={styles.container}><ThemedText>Missing booking data</ThemedText></View>;
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        {/* Proceed Button */}
        <TouchableOpacity 
          style={[styles.proceedButton, { backgroundColor: primary }]} 
